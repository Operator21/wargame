...
let infantryUnit = new Unit("infantry", "unit", [new ResourceAmount(playerData.population, 10000), new ResourceAmount(playerData.materials, 1000), new ResourceAmount(playerData.barracks, 1)], [new ResourceAmount(playerData.military, 10000), new ResourceAmount(playerData.barracks, 1)], 15);
let tankUnit = new Unit("tank", "unit", [new ResourceAmount(playerData.population, 2000), new ResourceAmount(playerData.materials, 4000), new ResourceAmount(playerData.oil, 500), new ResourceAmount(playerData.factories, 1)], [new ResourceAmount(playerData.military, 50000), new ResourceAmount(playerData.factories, 1)], 25);
